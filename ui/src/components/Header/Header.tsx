                ...
                <div className="usa-nav-container">
                    <div className="usa-navbar">
                        <div className="usa-logo" id="basic-logo">
                            <em className="usa-logo__text"><a href={titleRoute} title="Home" aria-label="Home">{title}</a></em>
                        </div>
                    ...
                    <nav aria-label="Primary navigation" className="usa-nav">
                        ...
                        <form className="usa-search usa-search--small ">
                            <div role="search">
                                ...
                                <button className="usa-button" type="submit"><span className="usa-sr-only">Search</span>
                                </button>
                            </div>
                        </form>
                    </nav>
