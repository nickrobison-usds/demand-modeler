...
export const addClusteredStackedChart = (
  ppt: pptxgen,
  slide: pptxgen.ISlide,
  data: Array<object>,
  options: object
) => {
  slide.addChart(ppt.ChartType.bar, data, {
    barGrouping: "stacked",
    barGapWidthPct: 20,
    ...options
  });
